...
class InfoGastoYEgresoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gastoEgresoRecibido = intent.getSerializableExtra("gastoEgresoEnviado") as GastosYEgresos
        ...
        miIdGastoEgreso = gastoEgresoRecibido.idGastoEgreso!! //id del gastoEgreso al que se le dió clic
    }
                    ...
                    setPositiveButton("Aceptar"){ _: DialogInterface, _: Int ->
                        ...
                        db.collection("gastosEgresos").document(miIdGastoEgreso)
                            ...
                            .addOnSuccessListener {
                                Toast.makeText(this@InfoGastoYEgresoActivity, "Gasto/Egreso Elimiando Correctamente", Toast.LENGTH_SHORT).show()
                            ...
                            .addOnFailureListener {
                                Toast.makeText(this@InfoGastoYEgresoActivity, "Ocurrió Un Error", Toast.LENGTH_SHORT).show()
                                //Se cierra actividad y regresa a la activity main
                                val i = Intent(applicationContext, GastosYEgresosActivity::class.java)
                                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
                                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
